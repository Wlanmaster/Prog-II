...
import demo009.menu.impl.CommandFuhrpark;
import demo009.menu.impl.CommandFuhrparkVerkaufen;
import demo009.menu.impl.CommandFuhrwerkKaufen;
import demo009.menu.impl.CommandGuthaben;
import demo009.menu.impl.CommandLagerBestand;
...
public class BusinessSimulation {
	...
	private Menu initMainMenu() {
		...
		subFuhrpark.setCommand(new CommandFuhrparkVerkaufen());
		...
		mainMenu.setCommand(new CommandLagerBestand());
		mainMenu.setCommand(new CommandGuthaben());
		mainMenu.setCommand(new CommandEinstellen());
